...
const CATEGORY_DASHBOARDS = {
  retail: {
    ...
    metrics: [
      ...
      { label: 'Purchase Value', value: money(74200), trend: '5 purchase entries', hash: '/purchase-reports' },
  ...
  school: {
    ...
    subtitle: 'Monitor students, attendance, fees, academics, and transport.',
    primaryChartTitle: 'Student Attendance',
    donutTitle: 'Fee Collection Status',
    listTitle: 'Class Strength',
    secondaryCardTitle: 'Academic Operations',
    inventoryTitle: 'Student Overview',
    scoreTitle: 'School Performance Score',
    metrics: [
      { label: 'Total Students', value: '1,248', trend: '32 new admissions', hash: '/school/students' },
      { label: 'Present Today', value: '1,174', trend: '94% attendance', hash: '/school/students' },
      { label: 'Fees Collected', value: money(684000), trend: '86% this month', hash: '/school/fee-collection' },
      { label: 'Upcoming Exams', value: '6', trend: 'Next exam in 4 days', hash: '/school/exams' },
    ],
    trend: [
    ...
    secondary: [
      { label: 'Classes', value: 42, color: '#2563eb', bg: '#eff6ff' },
      { label: 'Teachers', value: 68, color: '#16a34a', bg: '#f0fdf4' },
      { label: 'Fee dues', value: 92, color: '#d97706', bg: '#fffbeb' },
      { label: 'Transport routes', value: 18, color: '#7c3aed', bg: '#f5f3ff' },
    ],
