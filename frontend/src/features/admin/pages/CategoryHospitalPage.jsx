...
import { Search, RefreshCw, Download, Eye, Edit, AlertCircle, Heart, Users, TrendingUp } from 'lucide-react';
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gradient-to-r from-red-50 to-pink-50 border-b border-red-200">
                  <tr>
                    <th className="px-4 py-3 text-left text-xs font-bold text-red-900 uppercase tracking-wide">Staff Name</th>
                    <th className="px-4 py-3 text-left text-xs font-bold text-red-900 uppercase tracking-wide">Department</th>
                    <th className="px-4 py-3 text-left text-xs font-bold text-red-900 uppercase tracking-wide">Designation</th>
                    <th className="px-4 py-3 text-left text-xs font-bold text-red-900 uppercase tracking-wide">Status</th>
                    <th className="px-4 py-3 text-right text-xs font-bold text-red-900 uppercase tracking-wide">Actions</th>
                  </tr>
                </thead>
