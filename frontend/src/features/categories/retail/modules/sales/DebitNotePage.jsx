...
export function DebitNotePage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      setError('');
      try {
        const response = await api.listDebitNotes({ ...filters, search: debouncedSearch, dateFrom, dateTo, limit: FETCH_LIMIT });
    ...
    <div className="p-4 md:p-7">
      ...
      <div className="bg-white border border-[#dfe7f1] rounded-lg overflow-hidden">
        ...
        <div className="flex flex-wrap items-center justify-end gap-2 border-b border-[#edf2f7] px-4 py-2.5">
          ...
          />
          <ExportButtons title="Debit Notes" filename="debit-notes" rows={notes} columns={exportColumns} />
